...
public struct NYTimesConfiguration {
    ...
    public init() {}
    func config(name: String, endpoint: NYTimesEndpoint, responseModel: DataModelProtocol.Type, method: HTTPMethod = .get, contentType: ContentType = .queryParam, cachePolicy: NetworkCachePolicy = .noCache, headers: [String: String]) {
        do {
